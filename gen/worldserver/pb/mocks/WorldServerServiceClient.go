...
// CreateGuild provides a mock function with given fields: ctx, in, opts
func (_m *WorldServerServiceClient) CreateGuild(ctx context.Context, in *pb.CreateGuildRequest, opts ...grpc.CallOption) (*pb.CreateGuildResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *pb.CreateGuildResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *pb.CreateGuildRequest, ...grpc.CallOption) (*pb.CreateGuildResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *pb.CreateGuildRequest, ...grpc.CallOption) *pb.CreateGuildResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*pb.CreateGuildResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *pb.CreateGuildRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
